        ...
        if (state.scanTimedOut)
          Padding(
            ...
            child: GenericButton(
              ...
              width: 501,
              text: 'Refresh',
              onTap: () => _notifier.enterScanMode(),
            ),
          ),
        SizedBox(height: state.scanTimedOut ? 100 : 250),
      ],
    );
  }
}
...
class _DiscoveredDeviceTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Container(
      ...
      child: InkWell(
        onTap: disabled ? null : () => connectBluetoothDevice(ref, device),
        child: Padding(
